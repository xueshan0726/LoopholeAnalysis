...
public class GetFilePath {
	...
	public static void main(String Dir, String outDir) {
		...
		outputPath = outDir + "requirements.txt_sourcePath.csv";
		...
		System.out.println("Retrieving requirements.txt file ...");
		func(file);
	...
	private static void func(File file){
		try {
			...
			for(File f:fs){
				...
				if(f.isFile() && f.getName().equals("requirements.txt")){	//若是文件名称匹配，直接打印
